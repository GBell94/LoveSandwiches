...
def validate_data(values):
    """
    Inside the try, converts all string values to intergers. Raises ValueError if strings can't be converted
    to int or if there are exactly 6 values
    """
    try:
...
def get_last_5_entries_sales()
    """
    Collexts columns of data from sales worksheet, collecting last 5 entries
...
def calculate_stock_data():
    """
    Calculate the average storck for each item type, adding 10%
    """
